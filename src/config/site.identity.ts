export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'owntacit',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Owntacit',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'owntacit.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://owntacit.com',
